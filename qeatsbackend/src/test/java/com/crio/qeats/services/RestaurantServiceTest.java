...
class RestaurantServiceTest {
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
      ...
      // Load restaurants during normal hours
      List<Restaurant> restaurants = loadRestaurantsDuringNormalHours();
  
      // Call your service method to get response (using the helper)
      GetRestaurantsResponse allRestaurantsCloseBy =
          restaurantService.findAllRestaurantsCloseBy(
              new GetRestaurantsRequest(20.0, 30.0), LocalTime.of(12, 0)
          );
  
      // During non-peak hours, serving radius should include all 4 restaurants in fixture
